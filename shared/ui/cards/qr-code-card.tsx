  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center rounded-3xl text-center text-white">
        <div className="mb-4 w-full flex items-center justify-center rounded-3xl bg-white p-4 shadow-lg">
          {isLoading ? (
            ...
            <img src={src} alt="Pairing QR Code" className="w-full h-auto object-contain" />
          ) : (
