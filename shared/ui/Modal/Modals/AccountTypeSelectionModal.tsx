    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-8 sm:max-w-xl">
        <DialogHeader className="mb-4">
          <DialogTitle className="text-left text-2xl font-bold text-[var(--text-1)]">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div
              ...
              className="group flex cursor-pointer flex-col gap-3 rounded-xl bg-[var(--card-fill)] p-6 transition-all hover:bg-[var(--card-hover)] hover:ring-2 hover:ring-[var(--accent)]"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--accent)] text-white">
                <User className="h-5 w-5" />
              </div>
              <h3 className="text-lg font-semibold text-[var(--text-1)]">A Personal Account</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-[var(--text-1)]">A Business Account</h3>
              <p className="mt-1 text-sm text-slate-500">
