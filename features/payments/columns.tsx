...
export function getBillingsHistoryColumns() {
  const columns: TableColumn<BillingRecord>[] = [
    ...
    },
    {
      key: "amount",
      render: (item) => (
        <span>{getDefaultValue(formatCurrency(formatPaystackKoboAmount(item.amountNGN)))}</span>
      ),
    },
    // {
    //     key: "downloadUrl",
