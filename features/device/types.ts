...
export interface DeviceDetails extends BaseEntity {
  ...
  macAddress: string;
  manufacturer: string;
  assignmentStatus: "UNASSIGNED" | "ASSIGNED" | "RETURNED" | "REASSIGNED";
  mdmEnrollmentStatus: "ENROLLED" | "PENDING" | "UNENROLLED";
  mdmComplianceStatus: "COMPLIANT" | "NON_COMPLIANT";
  lastSeenAt: string | null;
  lastKnownLocation: string | null;
  deviceStatus: "ACTIVE" | "INACTIVE" | "LOCKED" | "DEACTIVATED" | "LOST" | "DAMAGED" | "OFFLINE";
  flagged: boolean;
