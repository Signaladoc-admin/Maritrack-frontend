...
export function ParentDevicesSection({ device, deviceId, isLoadingChild }: ParentDevicesSectionProps) {
  ...
  return (
    <div
      ...
      {...events}
      className="flex w-full cursor-grab items-start gap-6 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] *:min-w-full *:shrink-0 active:cursor-grabbing [&::-webkit-scrollbar]:hidden"
    >
      {device ? (
        <DeviceCard
