...
export function ChildrenDropdown() {
  ...
  return (
    <div className="relative w-full md:w-auto" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 w-72 rounded-3xl bg-white p-2 shadow-2xl animate-in fade-in zoom-in-95">
          <div className="flex flex-col gap-1">
            <button
              onClick={() => handleSelect("all")}
              className={cn(
                "flex w-full cursor-pointer items-center gap-4 rounded-2xl px-4 py-3 transition-colors hover:bg-[#F8F9FA]",
